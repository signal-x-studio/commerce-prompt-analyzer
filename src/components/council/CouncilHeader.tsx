...
export const CouncilHeader: React.FC = () => {
  return (
    <header className="text-center">
      ...
      <p className="mt-4 text-lg text-slate-600 max-w-2xl mx-auto">
        Query multiple AI models simultaneously, compare their responses through blind evaluation,
        and get a synthesized optimal answer. Inspired by{" "}
        <a
